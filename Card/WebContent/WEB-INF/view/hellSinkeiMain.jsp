...
<%for(int i=0;i<cardsList.size();i++){ %>
	...
	<%}else{ %>
		<form action="HellSinkeiMain?cardOpen=<%=i %>" method="post">
...
<form action="DebugHellSinkei">
<input type="image" title="ヒント:色も揃えろ" src="img/じゃがいも.png" class="potato">
</form>
</body>
</html>